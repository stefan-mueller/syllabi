...
{\large  
%\textcolor{Red}{Draft (Version: \today)}
}
Version: \today
\\
\bigskip
...
\begin{itemize}
%\item \fullcite[ch. 1--3]{lijphart12}.
\item \fullcite[ch. 10]{devries21}.* (not suitable for response paper)
...
\item \fullcite{budge15}.* (not suitable for response paper)
\end{itemize}
