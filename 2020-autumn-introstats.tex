...
\usepackage[paper=a4paper,left=22mm,right=22mm,top=25mm,bottom=25mm]{geometry}
...
-- information about people, parties, communication, firms, or nations. %Political scientists analyse data with an eye to explaining the social world. 
...
% For many social science questions, what we are really after is establishing whether there is a relationship between two variables of interest. And, we typically want to verify that there is no third variable explaining this relationship.
