...
{\Large \textbf{Introduction to Statistics} (\href{https://hub.ucd.ie/usis/!W_HU_MENU.P_PUBLISH?p_tag=MODULE&MODULE=POL40950}{POL40950})} 
\bigskip


{\large  Version: \today}\\
\bigskip
Latest version at: \url{https://muellerstefan.net/teaching/2021-autumn-introstats.pdf}
\end{center}
...
\item \fullcite{healy19}. URL: \url{https://socviz.co}.
\end{itemize}
...
\begin{itemize}
\item \fullcite{spiegelhalter20}.
%\item \fullcite{llaudet22}.
\end{itemize}

\item \textbf{Research design and causal inference}: 
\begin{itemize}
%\item \fullcite{buenodemesquita}.
\item \fullcite{huntingtonklein21}. URL: \url{https://theeffectbook.net}.
\item \fullcite{cunningham21}. URL: \url{https://mixtape.scunning.com}.
\end{itemize}
\item \textbf{\textsf{R} and regression analysis}: 
\begin{itemize}
\item \fullcite{larsen}. URL: \url{http://qpolr.com}.
%\item \fullcite{bryan}.
\item \fullcite{gelman20}.
%\item \fullcite{roback20}.
\end{itemize}
\item \textbf{Data visualisation}: \fullcite{wilke19}. URL: \url{https://clauswilke.com/dataviz/}.
\item \textbf{RMarkdown}: \fullcite[ch. 27, 29]{wickham17}. URL: \url{https://r4ds.had.co.nz}.
\end{itemize}
...
The sessions consist of lectures and labs each week. %Some of the lectures and labs will be online. 
The lectures focus on the fundamental aspects of statistical inference as well as the interpretation of these methods and examples. %The lectures will make use of small  exercises and quizzes.
...
%I will make extensive use of quizzes  throughout the lectures to increase engagement in times of blended learning. In addition, 
...
\section{Week 12: Improving the Interpretation and Visualisation of Regression Results (29 November--3 December 2021)}
...
\section{Week 12: Advanced Data Visualisation and Wrap-Up   (14 December--18 December 2020)}
